export function PhoneFrame({ children, nav }) {
  return (
    <div className="min-h-screen w-full flex justify-center bg-[#060606] py-0 sm:py-8">
      <div className="relative w-full sm:w-[400px] bg-ink-950 sm:rounded-[44px] sm:border-[10px] sm:border-ink-800 sm:shadow-2xl overflow-hidden flex flex-col"
        ...
        <div className="flex items-center justify-between px-7 pt-3 pb-1 text-xs font-medium text-white/90 shrink-0">
          <span>9:41</span>
